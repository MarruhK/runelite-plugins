...
public class PvpSupplyTrackerPlugin extends Plugin
{
	...
	private static final int[] COMBAT_SPELLS_ANIMATION = {AnimationID.BARRAGE, AnimationID.BLITZ, AnimationID.STRIKE,
															AnimationID.BOLT, AnimationID.BLAST, AnimationID.WAVE,
															AnimationID.SURGE, AnimationID.SNARE, AnimationID.ZAMMY_FLAMES,
															AnimationID.MAGIC_DART};
	...
	public void onExperienceChanged(ExperienceChanged event)
	{
		...
		{
			if (ArrayUtils.contains(COMBAT_SPELLS_ANIMATION, client.getLocalPlayer().getAnimation()))
			{
